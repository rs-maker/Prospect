...
class FifthPage extends StatelessWidget with NavigationStates {
  @override
    ...
    return Container(
      ...
      child: ListView(
          ...
          children: [
            RichText(
                text: TextSpan(
                    text:"Allgemeine Empfehlungen zur Einnahme von Roaccutane\n",
                    style: Theme.of(context).textTheme.headline1,
                    children: [
                  TextSpan(
                    text: "Wie bei allen verschreibungspflichtigen Arzneimitteln ist es unbedingt erforderlich, dass Sie "
