...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        backgroundColor: Color(0xFF5689B6),                            /*This is the color for any kind of text Background*/
        scaffoldBackgroundColor: Colors.white,                    /* Reserving this field for the eventual checklist background*/
        primaryColor: Color(0xFF005293),                              /* Primary color tobe used for SideBar and other big fields : TUM SECONDARY BLUE*/
